---
date: 2024-05-18
title: 'Daily Update – May 18, 2024'
...
execute:
    ...
    message: false
---
'We React | Why U.K.&#39;s Rwanda Asylum Deal Is Harmful; Why Black Americans Live Rent Free In The Mind Of Them Folks?; Is Chivalry Still Dead?; Learning from the Masters. #learning #master #ancient #knowledge; DL Hughley Calls Out &#39;Diddy&#39; For Beating Cassie Video: &quot;IT&#39;S OVER&quot; - CH News'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-05-18')-1)

---
date: 2025-09-29
title: 'Daily Update – Sep 29, 2025'
...
---
'Cardi B BLAMES MEN For Failed Relationships!; Truth About Pastor Joshua Mhlakela and the Pre-Trib Rapture Prophecy ; As A Man #man #men #manhood #cutinomobley #ineverknewtv; Unmasking Negativity Bias - How Expectations Shape Reality; Trinidad Fishers FEAR U.S. Warships | Are We Collateral Damage?'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-09-29')-1)

---
date: 2026-03-24
title: 'Daily Update – Mar 24, 2026'
...
---
'TPUSA’s Bizarre Reaction to Joe Kent’s Interview With Tucker Carlson…; 1914: Britain merged regions into Nigeria—not for unity, but for control and profit; Institutional Power vs Cultural Power: The Afroman Trial | The Blueprint For Black Power Book Review; Is The Market Crash Over… Or Just Getting Started? Here’s Exactly When To Buy (Iran War Impact); AFCON AWARDED TO MOROCCO FROM SENEGAL | ADIDAS WC KITS | USMNT SUPPORT DEBATE | IRAN WC STATUS +MORE'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2026-03-24')-1)

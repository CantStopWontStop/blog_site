---
date: 2024-02-23
title: 'Daily Update – Feb 23, 2024'
...
execute:
    ...
    message: false
---
'Seun Kuti Talks Revolution #Shorts (Part 1); Stop! You May Have Been Drinking Water The Wrong Way; Elijah McCoy invented a superior automatic oiling system for steam locomotives,; Mastering Marketing Strategy; Chat with  iam_marwa'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-02-23')-1)

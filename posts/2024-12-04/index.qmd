---
date: 2024-12-04
title: 'Daily Update – Dec 04, 2024'
...
---
'The Hosts  Of The View Are TURNING ON EACH OTHER After The Election; COACH CHALLENGE TO CHANGE VAR?! EP. 72 OUT NOW 🍿#football #soccer #var; The Festival Connecting Ghana to the World 🌎; Paul Pogba’s Broke Brother And Five Others Arrested For Trying To Blackmail Him; Shen Yun Human Trafficking: Inside the Anti-China Falun Gong Cult'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-12-04')-1)

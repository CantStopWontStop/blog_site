---
date: 2025-07-30
title: 'Daily Update – Jul 30, 2025'
...
---
'Where&#39;s your brother, Brigitte?; Would You Do This In Russia; I Have The Solution To The Majority Of FBA&#39;s Problems.; Why Black America Isn’t Worried About A White-Only Town + Exposing Their Schemes To Get Us Fired!; ASAP Rocky ‘Roasted’ For Wearing ‘Red Women&#39;s Shoes’, Style Backfires - HP News'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-07-30')-1)

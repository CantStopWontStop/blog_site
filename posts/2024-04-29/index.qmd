---
date: 2024-04-29
title: 'Daily Update – Apr 29, 2024'
...
execute:
    ...
    message: false
---
'A ride through the Wild side of Ghana; Should they BAN mini shin pads in football/soccer? (2/2) #football #soccer; Resisting the Jim Crow Laws in America. #jimin #racism. #america; How to Prepare for Black Swan Events in Finance; FORGERIES - w/ Prof. Manu Ampim'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-04-29')-1)

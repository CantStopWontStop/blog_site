...
---
'Conservative Group Mad Over U.S. City Issuing Reparations #Shorts #USA #Reparations; More Reasons Why Nigeria Is The Best Fit For The Black Diaspora; 🏢 Hollywood and the Pentagon: Unraveling The Hidden Influence; Synagogue of Satan the Imposters; Broken Play | Navv Greene Ft. Lou Young &amp; Brantlee Fields | S02 | EP40 | 06.22.24'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-06-23')-1)

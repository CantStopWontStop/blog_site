---
date: 2025-10-20
title: 'Daily Update – Oct 20, 2025'
...
---
'Black Americans Are NOT IMMIGRANTS! Why Is This So Hard To Believe?; I went to Egypt. (A Visit to the Cairo Museum); London Shaken! Joshua Maponga Declares the Rise of Africa’s Spiritual Revolution; Guyana’s Opposition Leader EXPOSED: U.S. Indictment Reveals $5.3M Gold Scheme!; It’s over for Kenya, people will fall by the millions.'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-10-20')-1)

---
date: 2025-03-07
title: 'Daily Update – Mar 07, 2025'
...
---
'Reaction to Roland Martin&#39;s State of Our Union Address; Clashes have erupted between the HTS-led government in Syria and an array of anti-HTS forces.; SA Parliament debates US decision to cut AID from South Africa; wow 3 countries meet here  !!! #travel #iam_marwa; Rep Jasmine Crockett&#39;s Sistagurl Persona Was Crafted By The DNC To Get The Black Vote'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-03-07')-1)

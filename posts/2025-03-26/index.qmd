---
date: 2025-03-26
title: 'Daily Update – Mar 26, 2025'
...
---
'Macklemore Speaks Out in Support of Mahmoud Khalil and Calls for a Free Palestine; I&#39;M Indingenous To America And My Social Security # Is Linked To The Federal Reserve; Women Are NOT REALLY HAPPY Alone &amp; This Is Why!; (Another) What race were the Egyptians video - TKM Reacts; Mrs Geraldine Don&#39;t Play, Them Folks Are Crashing Out Because Their Comfort Has Came To A End'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-03-26')-1)

---
date: 2025-12-19
title: 'Daily Update – Dec 19, 2025'
...
---
'Interconnectedness: Discover Your True Identity &amp; Connections #shorts; Piers Morgan you are phony; This time I give steve a link (no mid-stream ads); This time I give steve a link (no mid-stream ads); This time I give steve a link (no mid-stream ads)'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-12-19')-1)

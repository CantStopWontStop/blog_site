---
date: 2024-05-24
title: 'Daily Update – May 24, 2024'
...
execute:
    ...
    message: false
---
'Testing the Stream LIve from Africa; The Law is Clear: Palestinians Have Right to Resist Occupation w/ Vijay Prashad; Speed Dating Africa, come find your match.; Amenhotep III - Let&#39;s settle this...; Ask for Advice, Not Money'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-05-24')-1)

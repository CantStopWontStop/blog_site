...
---
'Martin Lawrence And Eddie Murphy To Reunite In New Movie, Murphy Reveals - CH News; The village raises the Child. #education #children; Pastor Chuck Missler Esau&#39;s Converts (watch to the end); Tribute to Chairman Omali Yeshitela: 60 Years of Service to Black Freedom and Liberation; Did the NSA Create Bitcoin? Exploring Bitcoin&#39;s Mysterious Origins'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-06-22')-1)

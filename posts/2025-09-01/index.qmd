---
date: 2025-09-01
title: 'Daily Update – Sep 01, 2025'
...
---
'Going Out of Business!; Take Me Down A Rabbithole Ep 41 - Hollywood Weirdos, Radioactive Oatmeal, Subliminals, and more; Closing Remarks &amp; Cultural Night with the Palestinian Youth Ensemble; LIVE DEBATE: The Race of the Ancient Egyptians (w/ @Mettabeshay); International News Publication Says the US Should Build a New Base in Eritrea'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-09-01')-1)

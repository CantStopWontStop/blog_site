...
---
'White South African Warns America About The Anti-Black Afrikaners Who Trump Allowed As Refugees; Woman Brings Her EX BABY DADDIES KIDS To Her NEW BABY DADDIES CRIB!; US General Refuses to Apologize to Ibrahim Traoré; Pentagon Strategy Increases Risk of Nuclear War with China; How powerful you become using STRATEGY:- The  African Diaspora through storytelling'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-05-14')-1)

---
date: 2024-12-10
title: 'Daily Update – Dec 10, 2024'
...
---
'Suspect For UnitedHealthCare CEO&#39;S Deletion Is In Custody!; Bitcoin to $10 Million? Why Bitcoin is the Future, TikTok Ban, &amp; Top Stocks to Hold ft Chris Johnson; Ben Shapiro and the Talmud Exposed; Traffic Reveals Who You Hate @clarklarewjones - Chocolate Sundaes Comedy #shorts; Israel bombs Syrian port of Latakia and air bases across country'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-12-10')-1)

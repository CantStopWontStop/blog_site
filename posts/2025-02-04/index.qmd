---
date: 2025-02-04
title: 'Daily Update – Feb 04, 2025'
...
---
'Brownsville, Texas on the border protested on horseback today for immigrants rights; Trump’s Tariff Threats, Time to Buy Nvidia?, “Cheap” Stocks, &amp; Timbaland on Music and Independence; President Trump Targets South Africa, Migrants Wave Foreign Flags During Anti-Deportation Protests; Katt Williams EXPOSES history&#39;s DARKEST secret!; Who Are Your Top 5 NFL Running Backs? | Broken Play w Navv and Lou #barrysanders'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-02-04')-1)

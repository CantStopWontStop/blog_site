---
date: 2024-11-17
title: 'Daily Update – Nov 17, 2024'
...
---
'Playing chess Charleston SC Spiritual Warfare; Shannon Sharpe &amp; Karlous Miller TELL THE TRUTH About Single Mothers &amp;  Women Are Big Mad; Texans gather to stand against the Global Conference for Israel held by the Jewish National Fund; Watch This from Africa, how we can transform our mother land; WW Questions Black Women On Why Sistas Want To Prioritize FBAs Only Instead Of Being Their Mule'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-11-17')-1)

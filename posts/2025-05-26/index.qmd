---
date: 2025-05-26
title: 'Daily Update – May 26, 2025'
...
---
'Take Me Down A Rabbithole; Black women Have Been BRAINWASHED To Believe That A Feminist Mindset Benefits Them!; SHORTS | TATIANA CRUMP TALKS ABOUT POP THE BALLOON SHOW; What Schools Won’t Say: Cleopatra’s Real Identity EXPOSED; Slave Ships: The CRUEL Dark Secrets Buried At Sea'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-05-26')-1)

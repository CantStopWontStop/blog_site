---
date: 2024-06-18
title: 'Daily Update – Jun 18, 2024'
...
execute:
    ...
    message: false
---
'HYPE MIC MONDAYS | Live From Atlanta 🔥; Stock Trading Master Class: NVIDIA Price Target, Cheatcode Stock Index, &amp; Blueprint to Pick Stocks; Charles Barron speaks the Electoral Campaign School; William Shakespeare the Israelite gift of David; The Darkside of Qatar'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-06-18')-1)

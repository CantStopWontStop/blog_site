---
date: 2025-06-08
title: 'Daily Update – Jun 08, 2025'
...
---
'Live: Faith Leaders and Activists Begin Journey to ICE Facility in Jena, LA; Reelblack Live - Why Are We Selling $50 T- Shirts?; Road to Savannah Breadcrumbs; Reading Through the Bible; Black Woman Sentenced to 7 Years for Killing Animals on Live Stream – Outrage Erupts!'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2025-06-08')-1)

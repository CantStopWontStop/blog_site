---
date: 2024-05-11
title: 'Daily Update – May 11, 2024'
...
execute:
    ...
    message: false
---
'&#39;world Sees Africa As One Big Zoo&#39; #Shorts #Africans; Brazilian shares how he became a international player in business; Unveiling the Impact: Forces Shaping Our Community; South African Ramaphosa shocked by Africa Importing Water from Europe; 17 African Sayings About Brotherhood And Their Modern Relevance'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-05-11')-1)

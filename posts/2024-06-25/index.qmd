...
---
'How to Beat the Market: Right Price to Buy NVIDIA, Next Market Crash, &amp; Buffett&#39;s New Stock Pick; African Woman Says She Comes To Other Countries To Take, Thanks Joe Biden For Making Migrants 1st; The Morning Meetup is FREE all week!; COPA AMERICA GROUP C PREDICTIONS, HOW WE DOING SO FAR; Pan African Intellectuals Failing To Address The Real Issues....A Response'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2024-06-25')-1)
